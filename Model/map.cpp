...
bool Map::Accessible(std::pair<int, int> point_1, std::pair<int, int> point_2) /*move*/
{
    ...
    if (x_1 == x_2 && y_1 > y_2)
    {
        ...
        if (map[x_1][y_1].left == Accessibility::PASSABLE && map[x_2][y_2].right == Accessibility::PASSABLE)
            return true;
    ...
    {
        qDebug() << "x_1 == x_2 && y_1 < y_2";
        if (map[x_1][y_1].right == Accessibility::PASSABLE && map[x_2][y_2].left == Accessibility::PASSABLE)
            return true;
    ...
    if (y_1 == y_2 && x_1 > x_2)
    {
        ...
        if (map[x_1][y_1].up == Accessibility::PASSABLE && map[x_2][y_2].down == Accessibility::PASSABLE)
            return true;
    ...
    if (y_1 == y_2 && x_1 < x_2)
    {
        ...
        // this->PrintMap();
        if (map[x_1][y_1].down == Accessibility::PASSABLE && map[x_2][y_2].up == Accessibility::PASSABLE)
            return true;
                            ...
                            std::pair<int, int> point_3, std::pair<int, int> point_4)
{
    ...
    if (bt == BarrierType::horizontal)
    {
        ...
        if (_1_2_accessible == false && _3_4_accessible == false)
            return false;
        return true;
    }
    else
    {
        ...
        if (_1_3_accessible == false && _2_4_accessible == false)
            return false;
        return true;
    }
